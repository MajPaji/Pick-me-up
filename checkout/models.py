...
class Receipt(models.Model):
    ...
    total_plus_tax = models.DecimalField(
        max_digits=10, decimal_places=2, null=False, default=0)
    ...
    def update_total_cost(self):
        ...
        """
        self.total_cost = self.lineitems.aggregate(Sum('lineitem_total'))[
            'lineitem_total__sum'] or 0
        self.total_plus_tax = self.total_cost + \
            self.total_cost * settings.TAX_PERCENTAGE / 100
        self.save()
